...
def rebuild_datasets():
    ...
    build_numpy_dataset_from_folder(PROCESSED_IMAGES_FOLDER_PATH, input_dataset_file_path)

    target_dataset_file_path = pjoin(DATASETS_FOLDER_PATH, TARGET_DATASET_NAME)
    build_numpy_dataset_from_folder(RAW_IMAGES_FOLDER_PATH, target_dataset_file_path)
